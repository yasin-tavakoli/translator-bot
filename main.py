...
class Config:
    ...
    DATABASE_URL = os.getenv('DATABASE_URL', 'postgresql://postgres.qwhkjpljsaledhqbgkbp:YasinBot2026%21Secure@aws-0-us-west-2.pooler.supabase.com:6543/postgres')    # تنظیمات امنیتی
